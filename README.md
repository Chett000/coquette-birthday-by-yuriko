...
<html lang="es">
  <head>
    ...
    <title>Coquette Birthday ✨</title>
    <style>
      @import url("https://fonts.googleapis.com/css2?family=Fredoka:wght@600&family=Quicksand:wght@500&display=swap");
      * {
      ...
      body {
        ...
        background: linear-gradient(135deg, #f8c7d4, #fbe8ea);
        display: flex;
      ...
      .sparkle {
        ...
        background: #f8c7d4;
        border-radius: 50%;
        box-shadow: 0 0 10px 4px #f8c7d4, 0 0 15px 7px #deaaff;
        animation: sparkleAnim 2.5s linear infinite;
        filter: drop-shadow(0 0 5px #deaaff);
        pointer-events: none;
        z-index: 0;
      }
